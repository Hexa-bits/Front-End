...
export const GET_MOVEMENTS_URL_WS = `ws://localhost:${PORT}${GAME}/my-mov-card?player_id=`;
export const GET_FIGURES_URL = `http://localhost:${PORT}${GAME}/my-fig-card?player_id=`;
export const GET_FIGURES_URL_WS = `ws://localhost:${PORT}${GAME}/my-fig-card?player_id=`;
